...
import { Calendar, Clock, CheckCircle, MessageCircle, Download, Sparkles, User, Phone, Mail, FileText } from 'lucide-react';
...
const SERVICES: ServiceOption[] = [
  {
    ...
    duration: '20 min',
    price: 'Gratuito',
    description: 'Análise inicial das oportunidades de IA e automação para o seu negócio.',
    popular: true
  },
  {
    id: 's2',
  ...
  return (
    <div className="pt-6 border-t border-slate-800/80 mb-6 text-left">
      ...
      <div className="flex items-center gap-2 mb-1">
        ...
        <h2 className="text-base font-bold text-white tracking-wide">Agendamento de Mentoria</h2>
      </div>
      <p className="text-xs text-slate-400 mb-4">
        Escolha o melhor serviço, data e horário para conversar diretamente com Israel de Jesus Silva.
      </p>
              ...
              {SERVICES.map((s) => (
                ...
                >
                  ...
                  <div className={`w-4 h-4 rounded-full border flex items-center justify-center mt-1 flex-shrink-0 ${
                    selectedService.id === s.id ? 'border-blue-400 bg-blue-500' : 'border-slate-600'
                  }`}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                ...
                <div className="relative">
                  ...
                  <input
                    type="email"
                    required
                    placeholder="Seu Melhores E-mail *"
                    value={email}
